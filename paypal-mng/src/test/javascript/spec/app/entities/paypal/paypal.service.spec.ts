...
describe('Service Tests', () => {
  describe('Paypal Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(PaypalService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Paypal(0, 'AAAAAAA', 'AAAAAAA', currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Paypal', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            created_at: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a Paypal', async () => {
